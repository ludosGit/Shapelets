...
try:
    ...
    from operators import (merge_crossover, point_crossover, 
     ...
     from GENDIS_python.gendis.operators import random_shapelet, kmeans
     from GENDIS_python.gendis.operators import add_shapelet, remove_shapelet, mask_shapelet
     from GENDIS_python.gendis.operators import (merge_crossover, point_crossover,
                                   shap_point_crossover)
...
class GeneticExtractor(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, population_size=50, iterations=25, verbose=False, 
                 ...
                 max_shaps=None, crossover_prob=0.4, n_jobs=1, min_len=0, max_len=None,
    ...
    def fit(self, X, y):
        ...
        # Maximum number of shapelets per set
